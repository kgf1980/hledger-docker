...
WORKDIR /build
RUN git clone --depth 1 --branch 1.51.2 https://github.com/simonmichael/hledger && cd hledger && ls && stack install --verbose hledger hledger-ui hledger-web
...
RUN stack install --resolver=$RESOLVER hledger-iadd-1.3.22
